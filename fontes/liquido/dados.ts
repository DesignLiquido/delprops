 ...
 */
const dados: DefinicaoPropriedadeInterface[] = [
  {
    nome: "tecnologia",
    tipo: "texto",
  ...
  },
  {
    ...
    tipo: "texto",
    detalhe:
      "Caminho do arquivo de banco de dados (ex: ':memory:' para SQLite em memória).",
  },
  {
    nome: "host",
    tipo: "texto",
  ...
  },
  {
    ...
    tipo: "texto",
    detalhe:
      "Arquivo de inicialização do banco (padrão: 'inicializacao.lincones').",
  },
];
