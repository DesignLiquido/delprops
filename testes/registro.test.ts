...
describe("Módulo Registro", () => {
  ...
  describe("registrar", () => {
    it("deve registrar uma nova propriedade para um namespace", () => {
      const definicoes: DefinicaoPropriedadeInterface[] = [
        {
          nome: "cor",
          tipo: "texto",
    ...
    it("deve permitir múltiplas contribuições para o mesmo namespace", () => {
      const definicoes1: DefinicaoPropriedadeInterface[] = [
        {
          nome: "cor",
          tipo: "texto",
          detalhe: "Cor do elemento",
      ...
      const definicoes2: DefinicaoPropriedadeInterface[] = [
        {
          nome: "visivel",
          tipo: "logico",
  ...
  describe("obter", () => {
    ...
    it("deve consolidar propriedades de múltiplos pacotes", () => {
      const def1: DefinicaoPropriedadeInterface[] = [
        { nome: "prop1", tipo: "texto", detalhe: "Propriedade 1" },
      ];
      const def2: DefinicaoPropriedadeInterface[] = [
